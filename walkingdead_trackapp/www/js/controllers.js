...
.controller('addCategoryCtrl', ['$scope', '$stateParams', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
// You can include any angular dependencies as parameters for this function
// TIP: Access Route Parameters for your page via $stateParams.parameterName
function ($scope, $stateParams) {
...
.controller('couriercontroller', ['$scope', '$http',
function ($scope, $http) {
    //  $http.get('http://beta3.irealtor.api.iproperty.com.my')
    $http({
        method: 'GET', url: 'http://beta3.irealtor.api.iproperty.com.my/AppData?types=1', headers: {
            'Authorization': 'Basic OWYvMFVVYitDUzJGd1IxM2doQmdnekZRY2pCd1pYSlVXUT090',
    ...
    .success(function (response) {
        ...
        console.log("$scope.courier :" + JSON.stringify($scope.couriers));
    }).error(function () {
       // alert('here');
    })
}]);
